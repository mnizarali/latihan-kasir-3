                                        ...
                                        <form method="POST" action="{{ route('dashboard.stock.updateStock', $stock->id) }}"
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input id="stock" class="form-control" name="stok"
...
<div class="modal fade" tabindex="-1" role="dialog" id="addStockModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('dashboard.stock.add') }}" class="needs-validation" novalidate="">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="product_name">Nama Produk<span class="text-danger">*</span></label>
                        <input id="product_name" class="form-control" name="namaProduk" tabindex="1"
                            type="text" required autofocus>
                        <div class="invalid-feedback">
                            Silahkan isi nama produk
                        </div>
